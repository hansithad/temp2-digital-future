...
export const features = [
  'Look for a high-profile, flexible digital talent',
  'Need additional resources for a fixed term project',
  "Need to rapidly close skills gap in the digital focused team",
...
export const jobs = [
  ...
  },
  {
    color: colors.deepOrange[500],
    title: 'Technology',
    jobTitle: 'Cloud Project Manager',
    type: 'Part Time',
    location: 'Paris, France',
    date: '5 days ago',
    companyLogo: 'https://assets.maccarianagency.com/the-front/logos/mailchimp.svg',
...
export const oldTalentFeatures = [
  {
    icon: 'far fa-comment',
    title: `360 Digital`,
    subtitle:
